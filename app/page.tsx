      ...
      <div className="root">
        <h1>
          ...
          <Line
            ...
            direction="horizontal"
            style={{
              top: 'calc(var(--lh) - var(--offset) * 2 + 4px)',
            }}
          />
          <Line
            variant="defined"
          ...
          <Line
            ...
            direction="horizontal"
            style={{
              top: 'calc(var(--lh) * 2 - var(--offset) * 2 + 4px)',
            }}
          />
          <Line
            variant="defined"
          ...
          <Line
            ...
            direction="horizontal"
            style={{
              top: 'calc(var(--lh) * 3 - var(--offset) * 2 + 4px)',
            }}
          />
          UI
          <br />
...
interface HorizontalFadeProps {
  side: 'left' | 'right';
}

function HorizontalFade({ side, ...props }: HorizontalFadeProps) {
  return (
...
function Line({ variant, direction, ...props }: LineProps) {
  return (
    <div
      aria-hidden
      className="line"
...
const mdxComponents = {
  h2: (props: { id: keyof typeof Icons; children: ReactNode }) => {
    return (
      <h2 {...props}>
        {Icons[props.id]}
        {props.children}
